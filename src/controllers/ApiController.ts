...
class ApiController {
    ...
    public async generateExcel(req: Request, res: Response) {
        try {
            ...
            res.setHeader('Content-Disposition', 'attachment; filename=processDetails.xlsx');
    ...
    public async paginateMovements(req: Request, res: Response) {
        try {
            ...
            const paginatedMovements = this.apiService.paginateMovements(movements, page, pageSize);
